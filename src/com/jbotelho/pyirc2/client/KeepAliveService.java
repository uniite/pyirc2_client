...
/* Based off the KeepAliveService example from http://code.google.com/p/android-random/
 * Also, mentioned in http://devtcg.blogspot.com/2009/01/push-services-implementing-persistent.html
 * */

public class KeepAliveService extends PushService
{
	public static final String TAG = "KeepAliveService";

	private static final String HOST = "192.168.7.100";
	private static final int PORT = 35421;
	...
	private void showNotification()
	{
		...
		// TODO: Change this to the relevant PushActivity
		// (to open when the notification is tapped)
	...
	/**
	 * Put some info about a new event in the notification bar.
	 * @param msg
	 */
	private void pushNotification(String msg)
	{
		...
		n.setLatestEventInfo(this, "New Push Message", "Message: " + msg, pi);
	...
	private class ConnectionThread extends Thread
	{
		...
		public void run()
		{
			...
			try {
				log("Attempting push connection.");
				...
				PushApplication app = getAppContext();
				PushActivity act = app.currentActivity;
				String data;
				
				DataInputStream reader = new DataInputStream(in);
				
				// Keep pulling down information pushed from the server
				while ((n = reader.readInt()) >= 0) {
					// n tells us how many bytes to read
